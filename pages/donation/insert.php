...
if (isset($_POST['add'])) {
    ...
    $insert = "INSERT INTO `donation`(`name`, `goal_ammount`, `email`, `categories_name`, `status`) VALUES ('$name','$ammount','$email','$categries_id','$status')";
        ...
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Donation</h4>
                ...
                <div class="modal-body mx-3">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="md-form col-sm-4">
                                <label data-error="wrong" data-success="right" for="defaultForm-email">emails</label>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="add" class="btn btn-default">Add Donation</button>
                </div>
            </form>
        </div>
    </div>
