...
if (isset($_GET['edit']) && ($_GET['edit'] != '')) {
    ...
    $select_single_data = "SELECT * FROM `donation` WHERE id=$id";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (isset($_POST['Submit'])) {
            ...
            $update = "UPDATE `donation` SET `name`='$name',`goal_ammount`='$ammount',`categories_name`='$categories_name',`status`='$status' WHERE `id`='$id'";
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="text" value="<?php echo $email ?>" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
