...
if (isset($_SESSION['username']) && ($_SESSION['username'] != '')) {
  $img = "SELECT * FROM `Gallery` WHERE `Gallery_type`='media'";
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Media Gallery Images </li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td> <a href="delete.php?del-media=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                              <td> <?php
                                    if ($rowimage['status'] == 1) {
                                      echo "<a class='btn btn-success' href='activedeactive.php?type=media&operation=deactive&id=" . $rowimage['id'] . "'>Active</a>";
                                    } else {
                                      echo "<a class='btn btn-secondary' href='activedeactive.php?type=media&operation=active&id=" . $rowimage['id'] . "'>Deactive</a>";
                                    }
