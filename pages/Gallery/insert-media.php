    ...
    $status = $_POST['status'];
        ...
        if (count($_FILES) > 0) {
            if (is_uploaded_file($_FILES['userImage']['tmp_name'])) {
                ...
                $sql = "INSERT INTO `Gallery`(`photos`, `description`,`link`, `Gallery_type`, `status`) VALUES ('{$imgData}','{$desc}','$link','media','{$status}')";
        ...
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="add" class="btn btn-default">Add Media </button>
                </div>
            </form>
        </div>
    </div>
