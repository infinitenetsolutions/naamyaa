              ...
              <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <?php } else { ?>
                      <a href="" class="btn btn-warning text-center" data-toggle="modal" data-target="#insert-details1">
                        Update
                      </a>
                    <?php } ?>
                    <br>
                              ...
                              <?php if ($title != '') { ?>
                                ...
                                <div class="mailbox-read-message">
                                  ...
                                  <div class="text-center ml-5 mr-5 ">
                                    <?php echo '<img  class="img-fluid img-width" src="data:image/jpeg;base64,' . base64_encode($image1) . '"/>'; ?>
                                  </div>
                                  <div class="mt-5 ml-5">
